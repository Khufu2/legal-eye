...
function LegalEye() {
  ...
  return <div className={"legal-app view-"+view}>
    ...
    <div className="workspace-stage">
      ...
      <footer className="workspace-footer"><span><i/> {corpusStats.searchable===null?"Corpus status unavailable":`${corpusStats.searchable.toLocaleString()} source passages`}</span><span>{documentCount.toLocaleString()} legal records</span><span>LOCKE · Legal intelligence.</span></footer>
    </div>
