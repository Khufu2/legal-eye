...
export function SkillsLive({ identity, connect, documents }: CommonProps & { documents: LiveVaultDocument[] }) {
  ...
  return <div className="view-pad"><LiveHeader title="Skills" meta="Version firm expertise into reusable, testable instructions that can run through LOCKE Agent." action={<Button onClick={() => { setSelected(null); setName("New legal skill"); setInstructions(""); }} disabled={!identity}><Plus/> New skill</Button>}/>
