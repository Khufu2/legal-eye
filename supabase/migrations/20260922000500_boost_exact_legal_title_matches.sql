-- Exact all-term title matches are strong navigational intent. Boost them above incidental
-- body matches while still returning diverse supporting passages and subsidiary material.
